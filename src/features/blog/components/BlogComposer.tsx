...
export function BlogComposer({ status, isPremium, onCreate }: BlogComposerProps) {
  return (
    <section className="px-5 pt-5">
      <DateRangeCard />
      <button className="mt-[18px] flex h-[61px] w-full items-center justify-center gap-3 rounded-xl bg-[#d0e2a9] text-[16px] font-bold text-[#4b4b4b] shadow-[0_7px_14px_rgba(45,51,34,0.13)]" onClick={onCreate}>
