 ...
 *
 * 값은 새로 만들지 않고 앱에 있던 것을 되살렸다 — 즐겨찾기 화면의 '저장한 장소' 정렬
 * 버튼이 쓰던 `linear-gradient(180deg, #ECF6D8, #FFF6D1)` 이다(`1bcf851` 에서 프로필
 * 재디자인과 함께 사라졌다). GREEN-100 에서 따뜻한 크림으로 내려온다.
 *
 * INK(`#2C3930`) 대비는 위 끝 10.4:1, 아래 끝 11.2:1 로 전 구간 AAA 다.
 *
...
const BACKDROP_CLASS =
  'fixed inset-0 -z-10 mx-auto sm:max-w-[390px] bg-[linear-gradient(180deg,#ECF6D8,#FFF6D1)]';
