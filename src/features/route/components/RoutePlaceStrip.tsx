...
interface RoutePlaceStripProps {
   ...
   * 얹혀 있고(`RouteViewPage`), 여기서는 어느 범위를 그릴지 알기 위해 값만 받는다.
   *
 ...
 *
 * 390×844 기준 422px — 손잡이·따라가기 줄·개수줄·저장 버튼을 뺀 목록 자리가 200px 남짓으로,
 ...
 * **날짜 칩이 반대로 시트 밖으로 나가면서 2.8줄로 돌아왔다.** 그래도 높이는 그대로 둔다 —
 ...
 *
 * 목록만 굴러간다 — 개수 줄과 저장 줄은 위아래에 붙박이라 굴리는 내내 제자리에 있다.
 *
