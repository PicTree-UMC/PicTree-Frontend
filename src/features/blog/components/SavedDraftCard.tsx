...
export function SavedDraftCard({ startDate, endDate, savedAt, onDelete }: SavedDraftCardProps) {
  ...
  return (
    <>
      <article className="relative mt-4 rounded-xl border-2 border-[#bed793] bg-white px-[23px] py-[20px]">
        <time className="absolute right-4 top-3 text-[10px] text-[#999]" dateTime={savedAt}>{formatLongDate(savedAt)} 저장 완료</time>
