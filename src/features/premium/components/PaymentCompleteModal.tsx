...
export function PaymentCompleteModal({ onConfirm }: { onConfirm: () => void }) {
  return (
    <ModalShell>
      ...
      <div className="mt-4 rounded-xl border-2 border-[#bed793] bg-white py-4 text-center text-[14px] font-bold leading-9">동선 무제한 저장<br/>AI 블로그 자동 생성<br/>광고 제거</div>
